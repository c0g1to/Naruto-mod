...
public enum ZoomLayer implements IAreaTransformer1 {
   ...
   public int func_215728_a(IExtendedNoiseRandom<?> p_215728_1_, IArea p_215728_2_, int p_215728_3_, int p_215728_4_) {
      int i = p_215728_2_.getValue(this.getOffsetX(p_215728_3_), this.getOffsetZ(p_215728_4_));
      ...
      if (j == 0 && k == 0) {
         ...
         int l = p_215728_2_.getValue(this.getOffsetX(p_215728_3_), this.getOffsetZ(p_215728_4_ + 1));
         int i1 = p_215728_1_.func_215715_a(i, l);
         if (j == 0 && k == 1) {
            return i1;
         } else {
            int j1 = p_215728_2_.getValue(this.getOffsetX(p_215728_3_ + 1), this.getOffsetZ(p_215728_4_));
            int k1 = p_215728_1_.func_215715_a(i, j1);
            if (j == 1 && k == 0) {
               return k1;
            } else {
               int l1 = p_215728_2_.getValue(this.getOffsetX(p_215728_3_ + 1), this.getOffsetZ(p_215728_4_ + 1));
